...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		separator_1_1.setBounds(68, 275, 289, 11);
		...
		txtFechaEntrada = new JDateChooser(fechaActual);
		...
		// txtFechaEntrada.addPropertyChangeListener("date", new ActionListener() {
		...
		txtFechaSalida = new JDateChooser(fechaActual);
	...
	private void calcularValor(JDateChooser txtFechaEntrada, JDateChooser txtFechaSalida) {
		if (txtFechaEntrada != null && txtFechaEntrada.getDate() != null && txtFechaSalida != null
				&& txtFechaSalida.getDate() != null) {
			// Obtén las fechas seleccionadas de los JDateChooser
			LocalDate fecha1 = LocalDate.ofInstant(txtFechaEntrada.getDate().toInstant(),
					txtFechaEntrada.getCalendar().getTimeZone().toZoneId());
			LocalDate fecha2 = LocalDate.ofInstant(txtFechaSalida.getDate().toInstant(),
					txtFechaSalida.getCalendar().getTimeZone().toZoneId());
	...
	private void guardarReserva() {
		...
		Reserva nuevaReserva = new Reserva(Date.valueOf(fechaE), Date.valueOf(fechaS),
				new BigDecimal(txtValor.getText()), txtFormaPago.getSelectedItem().toString());
